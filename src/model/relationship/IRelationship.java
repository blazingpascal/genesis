...
public interface IRelationship {
	...
	/**
	 * @return a number from -1 to 1, where -1 means they're worst enemies, 1
	 *         means they're best friends, and 0 means they don't know each
	 *         other
	 */
	...
	/**
	 * @return a number from -1 to 1, where -1 means they'd never ever date, 1
	 *         is means they're completely in love
	 */
	...
	void progressRelationship(int year, Random r);
