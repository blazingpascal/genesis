...
/**
 * Type of exceptions throwed by the PLPlan class.
 * <p>
 * PLPLAN
 ...
 */
class PlPlanException extends Exception{
    ...
    public PlPlanException(String s){
        super(s);
    }
    
    public PlPlanException(Throwable s){
        super(s);
    }
    
    public PlPlanException(String r, Throwable s){
        super(r, s);
    }
}
